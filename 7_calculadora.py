...
def main(page: ft.Page):
    ...
    numero2 = ft.TextField(label="Primeiro número", width=200, keyboard_type=ft.KeyboardType.NUMBER)
    ...
    def calcular(e):
        try:
            ...
            if not op:
                resultado.value, resultado.color = "⚠️Selecione uma operação", ft.Colors.ORANGE
