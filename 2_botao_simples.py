...
def main(page: ft.Page):
    ...
    # Criando um textp que será modificado pelo botão
    mensagem = ft.Text(
    ...
    def botao_clicado(evento):
        ...
        O parâmetro 'evento' contém informações sobre clique.
        """
        # Mudando o texto da mensagem
        mensagem.value = "🤩 Parbens! Você clicou no botão!"
        mensagem.color = ft.Colors.GREEN

        # IMPORTANTE: Sempre que modificamos elementos da interface,
        # precisamos chamar page.update() para que mudanças apareçam na tela
        page.update()
